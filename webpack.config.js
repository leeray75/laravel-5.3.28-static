...
module.exports = {
  context: __dirname+"/build/dev/js",
  entry: {
    "globals": "./globals/main.js",
    "users": "./apps/users/main.js",
    "contact-us": "./apps/contact-us/main.js",
    "vendor": ["jquery", "bootstrap"]
  },
  output: {
    path: __dirname+"/build/dev/js/bundles",
...
*/
  ...
  amd: { jQuery: true },
  plugins: [
    new webpack.optimize.CommonsChunkPlugin(/* chunkName= */"vendor", /* filename= */"vendors.bundle.js"),
